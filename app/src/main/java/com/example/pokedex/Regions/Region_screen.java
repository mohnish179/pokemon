...
public class Region_screen extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void get_info(int offset) {
        ...
        Call<PokemonAns> pokemonAnsCall = service.obtain_list_Pokemon("region", 20,offset);
